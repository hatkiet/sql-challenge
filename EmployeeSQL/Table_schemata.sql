...
CREATE TABLE employees (
	emp_no INT NOT NULL,
	emp_title_id VARCHAR(150) NOT NULL, -- Also found in titles(title_id)
...
CREATE TABLE dept_emp (
	...
	dept_no VARCHAR(150) NOT NULL, 	-- Also found in departments(dept_no)
